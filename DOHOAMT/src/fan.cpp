...
void Fan::drawFan()
{
    ...
    glPushMatrix();
    glRotatef(rotationAngle, 0.0f, 1.0f, 0.0f);// quay trục chính của quạt

    glPushMatrix();// vẽ hình vuông thứ 2 bên dưới
    ...
    glPushMatrix();//vẽ vòng tròn nối 4 cánh quạt
    glColor3f(.3, .3, .3);
    glRotatef(90, 1, 0, 0);
